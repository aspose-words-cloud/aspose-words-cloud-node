...
const {WordsApi, PostInsertDocumentWatermarkImageRequest } = require("asposewordscloud");
...
storageApi.PutCreate(imageName, versionId=null, storage=null, file= dataPath + imageName , function(responseMessage) {
	console.log('status:', responseMessage.status);
	console.log('body:', responseMessage.body);
});

var request = new PostInsertDocumentWatermarkImageRequest();
