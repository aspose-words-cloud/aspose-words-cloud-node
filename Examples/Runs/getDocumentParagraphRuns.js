...
const {WordsApi, GetDocumentParagraphRunsRequest } = require("asposewordscloud");
...
var request = new GetDocumentParagraphRunsRequest();
request.name = fileName;
request.folder = "";
request.paragraphPath = "sections/0/paragraphs/0";

wordsApi.getDocumentParagraphRuns(request).then((result) => {
