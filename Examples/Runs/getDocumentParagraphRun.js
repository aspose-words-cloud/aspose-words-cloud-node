...
const {WordsApi, GetDocumentParagraphRunRequest } = require("asposewordscloud");
...
var request = new GetDocumentParagraphRunRequest();
request.name = fileName;
request.folder = "";
request.paragraphPath = "sections/0/paragraphs/0";
request.index = 0;

wordsApi.getDocumentParagraphRun(request).then((result) => {
