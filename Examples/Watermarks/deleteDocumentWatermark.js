...
const {WordsApi, DeleteDocumentWatermarkRequest } = require("asposewordscloud");
...
var request = new DeleteDocumentWatermarkRequest();
request.name = fileName;
request.folder = ""; 

wordsApi.deleteDocumentWatermark(request).then((result) => {
