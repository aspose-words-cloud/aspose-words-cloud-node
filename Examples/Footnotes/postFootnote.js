...
const {WordsApi, PostFootnoteRequest, Footnote } = require("asposewordscloud");
...
var dataPath = '../../TestData/DocumentElements/Footnotes/';
...
var request = new PostFootnoteRequest();
request.name = fileName;
request.folder = "";
request.index = 0;
request.footnoteDto = new Footnote({ text: "new text" });

wordsApi.postFootnote(request).then((result) => {
