...
const {WordsApi, PutDocumentSaveAsTiffRequest, TiffSaveOptionsData } = require("asposewordscloud");
...
var request = new PutDocumentSaveAsTiffRequest({
                    saveOptions: new TiffSaveOptionsData({
                        saveFormat: "tiff",
                        fileName: "test_multi_pages.tiff",
                    }),
                });
request.name = fileName;
request.folder = "";

wordsApi.putDocumentSaveAsTiff(request).then((result) => {
