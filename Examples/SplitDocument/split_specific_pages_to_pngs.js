...
request.format = "png";
request.from = 1; // Splitting starts from the first page of the document
request.to = 2; // splitting ends at the last page of the document
request.folder = ""; // Input file exists at the root of the storage
request.zipOutput = true;
request.destFileName = "test_multi_pages.zip";
