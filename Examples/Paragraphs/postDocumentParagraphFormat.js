...
const {WordsApi, PostDocumentParagraphFormatRequest, ParagraphFormat } = require("asposewordscloud");
...
var request = new PostDocumentParagraphFormatRequest();
...
wordsApi.postDocumentParagraphFormat(request).then((result) => {
