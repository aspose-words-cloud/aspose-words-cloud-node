...
const {WordsApi, GetDocumentParagraphFormatRequest } = require("asposewordscloud");
...
var request = new GetDocumentParagraphFormatRequest();
request.name = fileName;
request.folder = "";
request.index = 0;

wordsApi.getDocumentParagraphFormat(request).then((result) => {
