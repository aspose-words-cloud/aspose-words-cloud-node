...
const { WordsApi, PutProtectDocumentRequest, ProtectionRequest } = require("asposewordscloud");
...
var request = new PutProtectDocumentRequest();
request.name = fileName;
request.folder = "";
request.protectionRequest = new ProtectionRequest({ newPassword: "123" });
request.destFileName = "PutProtectDocument.docx";

wordsApi.putProtectDocument(request).then((result) => {
