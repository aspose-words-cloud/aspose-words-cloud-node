...
const {WordsApi, GetDocumentParagraphsRequest } = require("asposewordscloud");
...
var request = new GetDocumentParagraphsRequest();
request.name = fileName;
request.folder = "";

wordsApi.getDocumentParagraphs(request).then((result) => {
