...
const { WordsApi, PutExecuteTemplateOnlineRequest } = require("asposewordscloud");
var fs = require('fs'); 
...
var templateFile = "SampleExecuteTemplate.docx";
var dataFile = "SampleExecuteTemplateData.txt";
var localPath = '../../TestData/DocumentActions/MailMerge/';

var request = new PutExecuteTemplateOnlineRequest({
    data: fs.readFileSync(localPath + dataFile),
    template: fs.readFileSync(localPath + templateFile),
});

wordsApi.putExecuteTemplateOnline(request).then((result) => {
