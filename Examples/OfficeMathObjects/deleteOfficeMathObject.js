...
const {WordsApi, DeleteOfficeMathObjectRequest } = require("asposewordscloud");
...
var dataPath = '../../TestData/DocumentElements/MathObjects/';
...
wordsApi.deleteOfficeMathObject(request).then((result) => {
