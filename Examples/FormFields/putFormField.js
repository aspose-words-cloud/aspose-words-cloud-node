...
const {WordsApi, PutFormFieldRequest, FormFieldTextInput } = require("asposewordscloud");
...
var request = new PutFormFieldRequest();
...
wordsApi.putFormField(request).then((result) => {
