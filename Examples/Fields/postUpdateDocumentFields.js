...
const {WordsApi, PostUpdateDocumentFieldsRequest } = require("asposewordscloud");
...
var dataPath = '../../TestData/DocumentElements/Fields/';
...
var request = new PostUpdateDocumentFieldsRequest();
request.name = fileName;
request.folder = ""; 

wordsApi.postUpdateDocumentFields(request).then((result) => {
