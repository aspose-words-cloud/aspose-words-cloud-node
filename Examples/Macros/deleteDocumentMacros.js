...
const {WordsApi, DeleteDocumentMacrosRequest } = require("asposewordscloud");
...
var request = new DeleteDocumentMacrosRequest();
request.name = fileName;
request.folder = "";

wordsApi.deleteDocumentMacros(request).then((result) => {
