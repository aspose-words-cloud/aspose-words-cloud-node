...
const {WordsApi, PostInsertPageNumbersRequest, PageNumber } = require("asposewordscloud");
...
var request = new PostInsertPageNumbersRequest();
request.name = fileName;
request.folder = "";
request.pageNumber = new PageNumber ({ alignment: "center", format: "{PAGE} of {NUMPAGES}" });

wordsApi.postInsertPageNumbers(request).then((result) => {
